...
>
> Note: the `calibration-audit` addendum (physics-underneath axiom,
> layer stack, in/out of scope) travelled with this file rather than
> being split out. It is still live content — promote it back to root
> as its own document if wanted.
